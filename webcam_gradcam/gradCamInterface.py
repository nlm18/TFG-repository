...
def save_and_display_gradcam_path(img_path, heatmap, cam_path="cam.jpg", alpha=0.2):
...
def display_gradcam(img, heatmap, return_image=True, alpha=0.4):
    # Rescale heatmap to a range 0-255
    heatmap = np.uint8(255 * heatmap)
    ...
    if return_image == True:
        ...
        superimposed_img = superimposed_img_array
