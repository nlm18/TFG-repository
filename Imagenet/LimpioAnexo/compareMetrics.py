...
header = ["-1", "-2", "Media de la intensidad de los pixeles", "-3",
          ...
          "Desviacion tipica de la intensidad de los pixeles", "-6",
          "Distancia al centroide maximo del heatmap", "-7",
          "Distancia al centroide minimo del heatmap", "-8",
          "Diferencia entre las medias de la intensidad de pixel con respecto a la original", "-9",
          "Norma de la diferencia entre la mascara con respecto a la original", "1-",
          "Norma de la diferencia entre la imagen adversaria con respecto a la original", "2-",
          "MSE", "3-",
          "PSNR", "4-",
          "SSIM", "5-"]
metricsName = ["Nombre de la red", "Imagenes a comparar",
