# ALT+MAYUS+INTRO Para formatear codigo ctrl+alt+g
import resNet
...
# Computed depth of version
depth = resNet.calculate_depth(version, n)
...
callbacks = [checkpoint, lr_reducer, resNet.lr_scheduler]
